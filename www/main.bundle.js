...
var AppComponent = /** @class */ (function () {
    function AppComponent(authService, router, ngZone) {
        ...
        this.router = router;
        this.ngZone = ngZone;
        this.title = 'deeplink and auth server';
        this.token = null;
        this.user = null;
        this.onDeeplinkRedirectPage = function (evenData) {
            _this.url = evenData;
            _this.authService.AuthInit()
                .then(function (isAuth) {
                console.log('deeplink app component auth init success', isAuth);
                _this.ngZone.run(function () {
                    _this.updateToken(999);
                });
                console.log('deeplink app component auth init user', _this.authService.user);
                console.log('deeplink app component auth init token', _this.authService.token);
                if (isAuth) {
                    _this.user = _this.authService.user;
                    _this.token = _this.authService.token;
                }
            }).catch(function (err) {
                console.log('deeplink app component auth init success', err);
            });
            _this.onNavigateByUrl(evenData.path, evenData.params);
        };
        this.onNavigateByUrl = function (path, params) {
            _this.ngZone.run(function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        ...
        this.authService.AuthInit()
            ...
            console.log('app component auth init user', _this.authService.user);
            console.log('app component auth init token', _this.authService.token);
            if (isAuth) {
                _this.user = _this.authService.user;
                _this.token = _this.authService.token;
            }
        ...
        document.addEventListener('deviceready', function () {
            universalLinks.subscribe('keycloak', _this.onDeeplinkRedirectPage);
        });
    };
    ...
    AppComponent.prototype.updateToken = function (number) {
