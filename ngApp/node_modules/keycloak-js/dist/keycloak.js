...
(function( window, undefined ) {
    ...
    var Keycloak = function (config) {
        ...
        function parseCallback(url) {
            ...
            console.log(url);
            console.log('parseCallback oauth', oauth);
            return oauth;
        }
        ...
        function parseCallbackUrl(url) {
            ...
            if (kc.responseMode === 'query' && queryIndex !== -1) {
                if(fragmentIndex < queryIndex){
                    ...
                    parsed = parseCallbackParams(url.substring(queryIndex + 1, fragmentIndex !== -1 &&  fragmentIndex > queryIndex ? fragmentIndex : url.length), supportedParams);
                    if (parsed.paramsString !== '') {
                        newUrl += '?' + parsed.paramsString;
                    }
                    if (fragmentIndex !== -1) {
                        newUrl += url.substring(fragmentIndex, queryIndex);
                    }
                }
                else{
